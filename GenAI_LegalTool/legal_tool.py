...
st.set_page_config(page_title="AI Legal Tool Agents", page_icon="⚖️", layout="wide")

# Title with emojis for visual appeal
st.markdown("<h1 style='text-align: center; color: #3e8e41;'>👨‍⚖️ AI Legal Tool Agents</h1>", unsafe_allow_html=True)
...
st.markdown("""
    <div style='text-align: center; font-size: 18px; color: #4B0082;'>
        ...
        <b>AI LegalStrategist</b>, and <b>AI Tool Lead</b> do the work for you. You can also ask 
...
if st.session_state.knowledge_base:
    ...
    Tool_lead = Agent(
        name="Toollead",
        model=Gemini(id="gemini-2.0-flash-exp"),
        description="Tool Lead AI - Integrates responses from the Legal Researcher, Contract Analyst, and Legal Strategist into a comprehensive report.",
        instructions=[
    ...
    if st.button("Analyze"):
        if not query:
            ...
            with st.spinner("Analyzing..."):
                response = get_Tool_response(query)
                ...
                with tabs[1]:
                    ...
                    key_points_response = Tool_lead.run(
                ...
                with tabs[2]:
                    ...
                    recommendations_response = Tool_lead.run(
